...
# test gem "puppet_litmus", '~> 0.36.0', '<= 0.36.1',                 require: false, platforms: [:ruby]   # Has to upgrade to 0.36.0, else action will not work, as matrix_from_metadata_v2 will only give proper code at this version
  gem "puppet_litmus", '> 0.36.1',                               require: false, platforms: [:ruby] 
# test    gem "puppet-module-posix-default-r#{minor_version}", '~> 0.4', require: false, platforms: [:ruby]
# test    gem "puppet-module-posix-dev-r#{minor_version}", '~> 0.4',     require: false, platforms: [:ruby]
# test    gem "puppet-module-win-default-r#{minor_version}", '~> 0.4',   require: false, platforms: [:mswin, :mingw, :x64_mingw]
# test    gem "puppet-module-win-dev-r#{minor_version}", '~> 0.4',       require: false, platforms: [:mswin, :mingw, :x64_mingw]
